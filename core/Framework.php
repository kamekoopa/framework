...
class core_Framework {
	...
	/**
	 * @access private
	 * @var famework\Framework このクラスのインスタンス
	 */
	private static $me;
	
	/**
	 * @access private
	 * @var framework\Configure 設定クラスのインスタンス
	 */
	private $config;
	...
	private function __construct($controllerDir, $viewDir){
		...
		$this->config = core_Configure::getInstance($controllerDir, $viewDir)
	 ...
	 * @param string $viewDir テンプレートが存在するディレクトリ
	 * 
	 * @return famework\core\core_Framework このクラスの唯一のインスタンス
	 */
	 ...
	 * @access public
	 * 
	 * @return framework\core\core_Configure このフレームワークの設定
	 */
